/*! For license information please see 703.18dd9f90.chunk.js.LICENSE.txt */
(self.webpackChunknareswara_certificate =
  self.webpackChunknareswara_certificate || []).push([
  [703],
  {
    8703: function (e) {
      e.exports = (function () {
        ...
        function re() {
          ...
          if ("function" === typeof l) {
            ...
            C.content &&
              C.content.ownerDocument &&
              (a = C.content.ownerDocument);
          }
          var oe = ne(g, r),
            ae = oe ? oe.createHTML("") : "",
            ie = a,
              ...
              (at && at === t) ||
                ...
                (Xe =
                  "ADD_URI_SAFE_ATTR" in t
                    ? L(M(Ze), t.ADD_URI_SAFE_ATTR, he)
                    : Ze),
                (Ve =
                  "ADD_DATA_URI_TAGS" in t
                    ? L(M($e), t.ADD_DATA_URI_TAGS, he)
                    : $e),
                (Ye =
                  "FORBID_CONTENTS" in t ? L({}, t.FORBID_CONTENTS, he) : Ke),
                ...
                qe &&
                  ...
                  !0 === qe.mathMl && (L(Ee, B), L(ke, q), L(ke, Y))),
                t.ADD_TAGS &&
                  (Ee === we && (Ee = M(Ee)), L(Ee, t.ADD_TAGS, he)),
                t.ADD_ATTR &&
                  (ke === Se && (ke = M(ke)), L(ke, t.ADD_ATTR, he)),
                t.ADD_URI_SAFE_ATTR && L(Xe, t.ADD_URI_SAFE_ATTR, he),
                t.FORBID_CONTENTS &&
                  (Ye === Ke && (Ye = M(Ye)), L(Ye, t.FORBID_CONTENTS, he)),
                Ge && (Ee["#text"] = !0),
          ...
          var dt = function (e) {
            ...
            At = function (e) {
              var t;
              if ((Nt("beforeSanitizeElements", e, null), vt(e)))
                return ht(e), !0;
            ...
            Et = function (e, t, n) {
              if (Be && ("id" === t || "name" === t) && (n in a || n in it))
                return !1;
              if (Re && !Oe[t] && O(be, t));
              else if (De && O(ve, t));
              else if (!ke[t] || Oe[t]) {
          ...
          return (
            (n.sanitize = function (o) {
              ...
              if (
                ...
                (1 ===
                  (l = (a = yt("\x3c!----\x3e")).ownerDocument.importNode(
                    o,
                    !0
                  )).nodeType &&
                  "BODY" === l.nodeName) ||
              ...
              if (He) {
                if (Ue)
                  for (m = ue.call(a.ownerDocument); a.firstChild; )
...
//# sourceMappingURL=703.18dd9f90.chunk.js.map
