  ...
  return (
    <>
      <div className="grid gap-4 grid-cols-3 grid-rows-3">
        <div>
          <a className="flex flex-col justify-between p-8 bg-white rounded-sm shadow-xl transition-shadow group hover:shadow-lg">
            <div>
        ...
        <div>
          <a className="block p-6 max-w-sm bg-white rounded-lg border border-gray-200 shadow-md hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
            ...
            <h2 className="mb-2 text-5xl font-bold tracking-tight text-gray-900 dark:text-white">
              10
            </h2>
          </a>
        </div>
