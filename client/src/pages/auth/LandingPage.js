        ...
        <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
          <div className="lg:max-w-lg lg:w-full md:w-1/2 w-5/6 mb-10 md:mb-0">
            <iframe
              className="w-full"
              height="315"
              src="https://www.youtube.com/embed/2d9UnJzArXo"
          ...
          <div className="lg:flex-grow md:w-1/2 lg:pl-24 md:pl-16 flex flex-col md:items-start md:text-left items-center text-center">
            <h1 className="title-font sm:text-4xl text-3xl mb-4 font-black text-gray-900">
              Panduan menginstall plugin Metamask
            </h1>
            <p className="mb-8 leading-relaxed text-justify">
              Metamask merupakan sebuah dompet kripto yang paling banyak
              digunakan, Metamask bisa diinstall sebagai plugin pada Browser
              Chrome, Mozilla, dan Edge. Untuk itu jika anda tidak memahami cara
              install yang tepat silahkan tonton video kami atau baca panduan
              ...
              <button
                onClick={(e) => {
                  window.location.href =
                    "https://drive.google.com/file/d/1NPSSsOQMo9TW7bgJNhQYdpnHsXmhdU-H/view?usp=drivesdk";
                }}
                type="button"
      ...
      <section className="text-gray-600 body-font" id="team">
        <div className="container px-5 py-24 mx-auto">
          <div className="flex flex-col text-center w-full mb-20">
            <h1 className="text-2xl font-black title-font mb-4 text-gray-900">
              Tim Kami
            </h1>
            <p className="lg:w-2/3 mx-auto leading-relaxed text-justify">
              Mengembangkan produk software Narescertificate kompleks, tim kami
              terdiri dari 3 orang dengan spesialisasi tersendiri. Kami saling
              bekerja sama demi tercapai nya misi kami untuk menjadi layanan
              sertifikat berbasis blockchain yang terpercaya
            </p>
          </div>
            ...
            <div className="p-4 lg:w-1/4 md:w-1/2">
              <div className="h-full flex flex-col items-center text-center">
                <img
                  ...
                  src="https://i.ibb.co/fnTWm3G/Whats-App-Image-2022-11-21-at-20-45-46.jpg"
                />
            ...
            <div className="p-4 lg:w-1/4 md:w-1/2">
              <div className="h-full flex flex-col items-center text-center">
                <img
                  alt="team"
                  className="flex-shrink-0 rounded-lg w-full h-56 object-cover object-center mb-4"
                  src="https://i.ibb.co/0s8ZSpZ/image.png"
                />
                <div className="w-full">
                  <h2 className="title-font font-medium text-lg text-gray-900">
                    M. Roy Farchan
            ...
            <div className="p-4 lg:w-1/4 md:w-1/2">
              <div className="h-full flex flex-col items-center text-center">
                <img
                  alt="team"
                  className="flex-shrink-0 rounded-lg w-full h-56 object-cover object-center mb-4"
                  src="https://i.ibb.co/mc285Cs/Whats-App-Image-2022-11-21-at-20-45-46-1.jpg"
                />
                <div className="w-full">
                  <h2 className="title-font font-medium text-lg text-gray-900">
                    Alan Al-Ansori
      ...
      <section className="text-gray-600 body-font relative" id="kontak">
        <div className="absolute inset-0 bg-gray-300">
          <iframe
            ...
            title="map"
            scrolling="no"
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3957.691977074115!2d112.79156701477496!3d-7.2758470947483636!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x2dd7fa10ea2ae883%3A0xbe22c55d60ef09c7!2sPoliteknik%20Elektronika%20Negeri%20Surabaya!5e0!3m2!1sid!2sid!4v1669039475351!5m2!1sid!2sid"
        ...
        <div className="container px-5 py-24 mx-auto flex">
          <div className="lg:w-1/3 md:w-1/2 bg-white rounded-lg p-8 flex flex-col md:ml-auto w-full mt-10 md:mt-0 relative z-10 shadow-md">
            ...
            <p className="leading-relaxed mb-5 text-gray-600">
              Beri kami umpan balik untuk memberi layanan sertifikat blockchain
              yang terbaik
            </p>
            ...
            <button className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2 text-center mr-3 md:mr-0 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
              Kirim Email
            </button>
          </div>
        </div>
